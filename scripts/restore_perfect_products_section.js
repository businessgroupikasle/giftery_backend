...
const perfectProductsSectionCode = `import BulkImportModal from './BulkImportModal';
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexWrap: 'wrap' }}>
            ...
            >
              ...
              <span style={{
                ...
                {activeCategoryFilter === 'all' && !debouncedSearch ? (meta.total || 0) : (meta.total || 0)}
              </span>
            </button>
      ...
      {showProductForm && productForm && (
        <div className={styles.cardContainer} style={{ background: '#ffffff', padding: '1.5rem', border: '1.5px solid #d99b26', borderRadius: '12px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.25rem', paddingBottom: '0.75rem', borderBottom: '1px solid #e2e8f0' }}>
            ...
            <button
              ...
              style={{ background: 'none', border: 'none', fontSize: '1.3rem', cursor: 'pointer', color: '#64748b', fontWeight: 'bold' }}
            >
              ✕
            </button>
          </div>
          ...
          <form onSubmit={async (e) => {
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1rem', marginBottom: '1.25rem' }}>
              ...
              <div>
                ...
                <select
                  ...
                  required
                  style={{ width: '100%', padding: '0.6rem 0.85rem', border: '1px solid #cbd5e1', borderRadius: '8px', fontSize: '0.85rem', background: '#fff' }}
                >
                      ...
                      {slots.map((url, idx) => (
                        <div key={idx} style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                          ...
                          <input
                            ...
                            style={{ flex: 1, padding: '0.5rem 0.75rem', border: '1px solid #cbd5e1', borderRadius: '6px', fontSize: '0.82rem' }}
                          />
                          <input
                            type="file"
                            accept="image/*"
              ...
              {/* Collections & Visibility Checkboxes */}
              <div style={{ gridColumn: '1 / -1', display: 'flex', flexWrap: 'wrap', gap: '1.25rem', marginTop: '0.5rem', padding: '0.85rem', background: '#f8fafc', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
            ...
            <div style={{ display: 'flex', gap: '0.75rem', justifyContent: 'flex-end', marginTop: '0.5rem' }}>
              <button
                type="button"
                onClick={handleCloseModal}
                style={{ padding: '0.65rem 1.4rem', background: '#f8fafc', border: '1px solid #cbd5e1', borderRadius: '8px', fontWeight: '600', cursor: 'pointer', color: '#475569' }}
              >
                Cancel
              </button>
              <button
...
fs.writeFileSync(psPath, perfectProductsSectionCode, 'utf8');
console.log('✅ ProductsSection.jsx restored with perfect styling and layout matching Image 2');
